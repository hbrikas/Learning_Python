...
while counter>0:
    ...
    move=random.randint(20,200)
    #random degrees to turn
    turn=random.randint(-2,2)
    turn=turn*90

    print ("MOVE : ", move, " TURN : ",turn)
